    ...
    <header className="sticky top-0 z-40 w-full border-b border-border/60 bg-background/85 backdrop-blur-xl">
      <div className="container mx-auto flex h-16 items-center gap-3 px-4 md:h-20 md:gap-6">
        <a href="/" className="flex items-center gap-2 shrink-0">
          <span className="grid h-9 w-9 place-items-center rounded-xl bg-bolt-gradient shadow-bolt md:h-10 md:w-10">
            <Zap className="h-5 w-5 fill-ink text-ink" strokeWidth={2.5} />
          </span>
